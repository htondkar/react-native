      ...
      <ScrollView style={styles.wrapper}>
        <View style={styles.paragraph}>
          ...
          <Text>
            ...
            pharmacokinetic interactions between dexmedetomidine and isoflurane,
            propofol, alfentanil, and midazolam have been demonstrated. However,
            due to possible pharmacodynamic interactions, when coadministered
            with Dexmedetomidine, a reduction in dosage of Dexmedetomidine on
            the concomitant anesthetic, sedative, hypnotic or opioid may be
            required.
          </Text>
        </View>
        <View style={styles.paragraph}>
